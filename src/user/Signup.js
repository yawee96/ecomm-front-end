...
function Signup() {
    ...
    const clickSubmit = (event) => {
        ...
        let name = appendName(values.firstName, values.lastName)
        console.log(name);
        const { email, password, phone, country, company } = values;
        signup(name, email, password, phone, country, company)
            .then(data => {
                ...
                <div className="row">
                    <div className=" col-md-4">
                        ...
                        <div className="form-group">
                            ...
                            {/* : {values.firstName} */}
                            <input type="text" value={values.firstName} onChange={handleChange("firstName")} className="form-control" required/>
                        </div>
                        <div className="form-group">
                            <label className="text-muted">Last Name</label>
                            {/* : {values.lastName} */}
                            <input type="text" value={values.lastName} onChange={handleChange("lastName")} className="form-control" required/>
                        </div>

                        <div className="form-group">
                            <label className="text-muted">Phone</label>
                            {/* : {values.phone} */}
                            <input type="text" value={values.phone} onChange={handleChange("phone")} className="form-control" required/>
                        </div>
                        <div className="form-group">
                            {/* <input type="text" onChange={handleChange("country")} className="form-control" /> */}
                            <label className="text-muted" htmlFor="country">Country</label>
                            {/* : {values.country} */}
                            <select onChange={handleChange("country")} value={values.country} id="country" name="country" className="form-control" required>
                                <option> ------------ </option>
                    ...
                    <div className=" col-md-4">
                        ...
                        <div className="form-group">
                            ...
                            {/* : {values.company} */}
                            <input type="text" value={values.company} onChange={handleChange("company")} className="form-control" required/>
                        </div>
                        {/* <div className="form-group">
                            <label className="text-muted">Email</label>
                            : {values.email}
    ...
    const showSuccess = () => {
        return (<div className="alert alert-success" style={{ display: values.success ? "" : "none" }}>
    ...
    return (
        <Layout
            ...
            description="Get access to buyers all over North America"
